...
public class PostResponse {
    ...
    private PostResponse(Long id, Long authorId, String authorName, String authorProfileImageUrl,
            PostSubCategory subCategory, PostCategory category, PostStatus status, String content,
    ...
    public static PostResponse from(Post post, long commentCount) {
        return from(post, commentCount, null);
    }

    public static PostResponse from(Post post, long commentCount, String authorProfileImageUrl) {
